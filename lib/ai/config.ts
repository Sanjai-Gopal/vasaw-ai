...
const providers: ProviderConfig[] = [
  {
    ...
    models: {
      general: env("NVIDIA_GENERAL_MODEL") ?? "meta/llama-3.3-70b-instruct",
      reasoning: env("NVIDIA_REASONING_MODEL") ?? "deepseek/deepseek-r1",
      coding: env("NVIDIA_CODING_MODEL") ?? "qwen/qwen2.5-coder-32b-instruct",
    },
    priority: 1,
  },
  {
